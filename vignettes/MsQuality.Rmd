...
- *chromatographyDuration* (MS:4000053): Duration of chromatographic run (same generic as for `Spectra`)
- *numberChromatograms* (MS:4000071): Total number of chromatograms
- *rtAcquisitionRange* (MS:4000070): RT range across chromatograms (same generic as for `Spectra`)
