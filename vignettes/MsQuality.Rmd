...
- *peakCount*: Number of detected peaks per chromatogram
...
- *numberEmptyScans*: Count of empty chromatograms
...
- *gaussianSimilarity*: Peak shape quality (correlation to beta distribution, residual SD)
- *peakProminence*: Peak prominence relative to baseline
...
- *msSignal10xChange*: Count of 10x intensity jumps/falls
- *medianTicRtIqr*: Median TIC in RT IQR
- *baselineIntensity*: 5th percentile (baseline estimate)
- *signalToNoiseRatio*: Classical S/N ratio (MAD-based noise estimate)
