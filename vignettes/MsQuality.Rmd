...
- *chromatogramCount* (MS:4000071): Total number of chromatograms
...
- *intensityQuartiles*, *intensityRange*: Intensity distributions
- *numberEmptyChrom*: Count of empty chromatograms
- *xicFwhm*: Full Width at Half Maximum (FWHM) per chromatogram
- *peakBoundary*: Left/right peak boundaries using valley detection
- *peakWidth*: Peak width based on valley boundaries
- *peakBeta*: Peak shape quality metrics (correlation to beta distribution)
- *ticQuantileRtFraction* (MS:4000183): RT fraction when TIC quantiles accumulate
- *areaUnderTic* (MS:4000155): Total area under TIC
- *areaUnderTicRtQuantiles* (MS:4000156): Area under TIC per RT quartile
- *areaUnderTicMs1* (MS:4000029): Area under TIC for MS1
- *areaUnderTicMs2* (MS:4000030): Area under TIC for MS2
...
- *rtIqr*: RT interquartile range

For complete documentation of each metric, including calculation details and
PSI-MS accessions, see the respective help pages (e.g., `?chromatographyDuration`,
`?xicFwhm`).
