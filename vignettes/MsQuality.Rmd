...
files from the `sciex` data set of the `MsDataHub` package and create a `Spectra`
...
sps_sciex <- Spectra(MsBackendMzR(), files = sciex_file)
```
...
- *chromatographyDuration*, **chromatography duration** (MS:4000053),
  ...
  The metric is calculated as follows:
    ...
    (3) the difference between the maximum and the minimum is calculated andreturned.
